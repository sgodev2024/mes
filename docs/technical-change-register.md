...
> Sinh tự động từ Git. Mốc mã gần nhất: `bd415242f7cdf1bbfd25b57481512413e025ce3c` (2026-09-10). Không sửa trực tiếp phần này.

| Ngày | Commit | Nội dung | Tác giả | Số file |
|---|---|---|---|---:|
| 2026-09-10 | [`bd41524`](https://github.com/sgodev2024/java-core/commit/bd415242f7cdf1bbfd25b57481512413e025ce3c) | feat(mes): finalize dashboard and workforce workflows | sgodev2024 | 13 |
| 2026-09-10 | [`3a6619a`](https://github.com/sgodev2024/java-core/commit/3a6619a367bdeaaae69f8ccbe494541c5e6d275e) | Update MES executive dashboard | sgodev2024 | 3 |
...
### 2026-09-10 — feat(mes): finalize dashboard and workforce workflows

- Commit: [`bd415242f7cdf1bbfd25b57481512413e025ce3c`](https://github.com/sgodev2024/java-core/commit/bd415242f7cdf1bbfd25b57481512413e025ce3c)
- Tác giả: sgodev2024
- Phạm vi file:

- `M` `backend/src/main/java/vn/coreplatform/mes/operations/MesOperationalModuleController.java`
- `M` `backend/src/main/java/vn/coreplatform/mes/operations/MesOperationalModuleService.java`
- `A` `backend/src/main/resources/db/migration/V26__workforce_labor_tabs.sql`
- `M` `backend/src/test/java/vn/coreplatform/mes/MesOperationalModuleApiTest.java`
- `A` `docs/22-mes-workforce-labor-functional-baseline-v1.0.md`
- `M` `frontend/app/globals.css`
- `M` `frontend/app/mes/mes-demo-data.ts`
- `M` `frontend/app/mes/mes-executive-dashboard.tsx`
- `M` `frontend/app/mes/mes-inventory-reconciliation.tsx`
- `M` `frontend/app/mes/mes-live-api.ts`
- `M` `frontend/app/mes/mes-workspace.tsx`
- `M` `frontend/app/page.tsx`
- `M` `frontend/tests/rendered-html.test.mjs`

### 2026-09-10 — Update MES executive dashboard

- Commit: [`3a6619a367bdeaaae69f8ccbe494541c5e6d275e`](https://github.com/sgodev2024/java-core/commit/3a6619a367bdeaaae69f8ccbe494541c5e6d275e)
- Tác giả: sgodev2024
- Phạm vi file:
...
- Commit: [`7714637395ba9285fa032657c2c7b26c6efa0621`](https://github.com/sgodev2024/java-core/commit/7714637395ba9285fa032657c2c7b26c6efa0621)
- Tác giả: sgodev2024
- Phạm vi file:
...
- Commit: [`a6bf755a73a94b91a5ea626b5008f0d60656402f`](https://github.com/sgodev2024/java-core/commit/a6bf755a73a94b91a5ea626b5008f0d60656402f)
- Tác giả: sgodev2024
- Phạm vi file:

- `M` `backend/src/main/java/vn/coreplatform/security/SecurityConfig.java`
- `M` `backend/src/test/java/vn/coreplatform/identity/PasswordPolicyTest.java`
